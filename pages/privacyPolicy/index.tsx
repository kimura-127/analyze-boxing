        ...
        <main>
            <div className={styles.termsContainer}>
                ...
                <section className={styles.termsSection}>
                    ...
                    <p>AnalyzeBoxing（以下、「当社」とします）は、当社が運営するWebサービス（以下、「本サービス」とします）において、お客様のプライバシーを尊重し、
                        お客様から提供される個人情報の保護に努めています。本プライバシーポリシーは、本サービスを利用される際に、当社がどのような情報を収集し、その情報をどのように扱うかについて説明しています。
                    </p>
                    ...
                    <p>
                        当社は、法律に基づく場合やお客様の同意がある場合を除き、お客様の個人情報を第三者に提供することはありません。ただし、
                        Google Analyticsのような第三者サービスを利用しており、これらのサービス提供者がデータを収集・分析する場合があります。
                    </p>

                    <h2 className={styles.termsHeading}></h2>
                    <p>
                        お客様からの個人情報に関するお問い合わせは、以下のメールアドレスまでお願いいたします。 <br />
                        Email: kimuraramuki127@gmail.com
                    </p>

                    <h2 className={styles.termsHeading}>改訂</h2>
                    <p>
                        本プライバシーポリシーは、法令の変更や本サービスの変更に応じて、必要に応じて改訂されることがあります。
                        改訂された場合は、本サービス上で適切にお知らせします。
                    </p>
                </section>
