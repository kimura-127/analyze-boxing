        ...
        <div className={styles.termsContainer}>
            ...
            <section className={styles.termsSection}>
                ...
                <p>
                    ...
                    ユーザーは、本サービスの利用に伴うこれらの費用を理解し、同意の上でサービスを利用するものとします。
                </p>

                <h2 className={styles.termsHeading}>第3条（禁止事項）</h2>
                <p>
                ...
                <h2 className={styles.termsHeading}>第4条（本サービスの提供の停止等）</h2>
                <p>
                ...
                <h2 className={styles.termsHeading}>第5条（利用制限）</h2>
                <p>
                ...
                <h2 className={styles.termsHeading}>第6条（退会）</h2>
                <p>ユーザーは，当社の定める退会手続により，本サービスから退会できるものとします。</p>

                <h2 className={styles.termsHeading}>第7条（保証の否認および免責事項）</h2>
                <p>
                ...
                <h2 className={styles.termsHeading}>第8条（サービス内容の変更等）</h2>
                <p>
                    当社は，ユーザーへの事前の告知をもって、本サービスの内容を変更、追加または廃止することがあり、ユーザーはこれを承諾するものとします。
                </p>

                <h2 className={styles.termsHeading}>第9条（利用規約の変更）</h2>
                <p>
                ...
                <h2 className={styles.termsHeading}>第10条（個人情報の取扱い）</h2>
                <p>
                    当社は，本サービスの利用によって取得する個人情報については，当社「プライバシーポリシー」に従い適切に取り扱うものとします。
                </p>

                <h2 className={styles.termsHeading}>第11条（通知または連絡）</h2>
                <p>
                ...
                <h2 className={styles.termsHeading}>第12条（権利義務の譲渡の禁止）</h2>
                <p>
                    ユーザーは，当社の書面による事前の承諾なく，
                    利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し，または担保に供することはできません。
                </p>

                <h2 className={styles.termsHeading}>第13条（準拠法・裁判管轄）</h2>
                <p>
                    本規約の解釈にあたっては，日本法を準拠法とします。サービスに関して紛争が生じた場合には，
