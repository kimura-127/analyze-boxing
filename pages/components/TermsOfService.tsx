    ...
    return (
        <div className={styles.termsContainer}>
            ...
            <section className={styles.termsSection}>
                <p>この利用規約（以下、「本規約」といいます。）は、AnalyzeBoxing（以下、「当社」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。</p>

                <h2 className={styles.termsHeading}>第1条（適用）</h2>
                <p>本規約は，ユーザーと当社との間の本サービスの利用に関わる一切の関係に適用されるものとします。</p>
                {/* <h2 className={styles.termsHeading}></h2> */}

                <h2 className={styles.termsHeading}>第2条（利用料金および支払方法）</h2>
                <p>本サービスは、基本的に無料で利用することができます。
                    従って、ユーザーは本サービスの利用に関して利用料金を支払う義務はありません。
                    将来的に有料サービスが提供される場合、その利用に関する料金および支払方法については、当社が別途定め、本ウェブサイトにて告知します。
                    ただし、本サービスの利用にはインターネット接続が必要であり、そのための通信料金やプロバイダー契約料、携帯キャリアによるデータ使用料などの通信に関わる費用は、ユーザーの自己責任および自己負担となります。
                    ユーザーは、本サービスの利用に伴うこれらの費用を理解し、同意の上でサービスを利用するものとします。</p>

                <h2 className={styles.termsHeading}>第5条（禁止事項）</h2>
                <p>ユーザーは，本サービスの利用にあたり，以下の行為をしてはなりません。<br />
                    ...
                    15. その他，当社が不適切と判断する行為</p>
                <h2 className={styles.termsHeading}>第6条（本サービスの提供の停止等）</h2>
                <p>当社は，本サービスの提供の停止または中断により，ユーザーまたは第三者が被ったいかなる不利益または損害についても，一切の責任を負わないものとします。<br />
                ...
                <h2 className={styles.termsHeading}>第6条（利用制限）</h2>
                <p>当社は，ユーザーが以下のいずれかに該当する場合には，事前の通知なく，ユーザーに対して，本サービスの全部もしくは一部の利用を制限し、
                    本規約のいずれかの条項に違反した場合
                ...
                <h2 className={styles.termsHeading}>第7条（退会）</h2>
                <p>ユーザーは，当社の定める退会手続により，本サービスから退会できるものとします。</p>
                <h2 className={styles.termsHeading}>第8条（保証の否認および免責事項）</h2>
                ...
                <h2 className={styles.termsHeading}>第9条（サービス内容の変更等）</h2>
                <p>当社は，ユーザーへの事前の告知をもって、本サービスの内容を変更、追加または廃止することがあり、ユーザーはこれを承諾するものとします。

                </p>
                <h2 className={styles.termsHeading}>第10条（利用規約の変更）</h2>
                ...
                <h2 className={styles.termsHeading}>第11条（個人情報の取扱い）</h2>
                <p>当社は，本サービスの利用によって取得する個人情報については，当社「プライバシーポリシー」に従い適切に取り扱うものとします。</p>
                <h2 className={styles.termsHeading}>第12条（通知または連絡）</h2>
                ...
                <h2 className={styles.termsHeading}>第13条（権利義務の譲渡の禁止）</h2>
                <p>ユーザーは，当社の書面による事前の承諾なく，利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し，または担保に供することはできません。</p>
                <h2 className={styles.termsHeading}>第15条（準拠法・裁判管轄）</h2>
                <p>本規約の解釈にあたっては，日本法を準拠法とします。サービスに関して紛争が生じた場合には，当社の本店所在地を管轄する裁判所を専属的合意管轄とします。</p>
            </section>
